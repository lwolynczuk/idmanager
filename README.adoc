...
[source,java]
----
include::./src/test/java/pl/moskitek/idmanager/usecase/instantiate/DefaultIdManager.java[]
----
...
.Ogranisation
----
include::./src/main/java/pl/moskitek/idmanager/Organisation.java[]
----
...
.Purpose
----
include::./src/main/java/pl/moskitek/idmanager/IdManager.java[]
----
